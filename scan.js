...
function checkIndexUsage() {
    return __awaiter(this, void 0, void 0, function () {
        var uri, client, database, collection, query, explainOutput, executionStages, stage, inputStage, inputStageType, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    explainOutput = _a.sent();
                    executionStages = explainOutput.executionStats.executionStages;
                    stage = executionStages.stage;
                    if (stage === "COLLSCAN") {
                        console.log('Query used a COLLSCAN (collection scan) without index.');
                    }
                    else if (stage === "FETCH") {
                        inputStage = executionStages.inputStage;
                        inputStageType = inputStage.stage;
                        if (inputStageType === "IXSCAN") {
                            console.log('Query used an IXSCAN index.');
                        }
                        else {
                            console.log('Query used a different index type or combination.');
                        }
                    }
                    else {
                        console.log('Query used a different execution stage.');
                    }
                    return [3 /*break*/, 7];
                case 4:
                    error_1 = _a.sent();
